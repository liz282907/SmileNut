$(document).ready(function(){
	...
	var validate = $("#signupForm").validate({
		...
		messages: {
            contact: {
				required: $.i18n.prop("请输入用户昵称"),
                minlength: jQuery.format($.i18n.prop("用户昵称过短")),
                maxlength: jQuery.format($.i18n.prop("用户昵称过长"))
			},
			email: {
			...
			password: {
				...
				minlength: jQuery.format($.i18n.prop("密码长度过短")),
			...
			passwordAgain: {
				...
				minlength: jQuery.format($.i18n.prop("密码长度过短")),
				maxlength: jQuery.format($.i18n.prop("密码长度过长")),
				equalTo: jQuery.format($.i18n.prop("两次输入不一致"))
			},
		}
	});
